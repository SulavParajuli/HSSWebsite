    ...
    <div class="col-sm-8 text-left"> 
      ...
      <?php  
        ...
        if ($conn->connect_error) {
            ...
            $sql = "SELECT * FROM `result` WHERE `result`.`symbol` = $postid ";
      ...
      <form action="update.php" method="get">
            Symbol:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="symbol" value="<?php echo $symbol;?>"><br><br>
            Percentage:  <input type="text" name="percent" value="<?php echo $percent;?>"><br><br>
